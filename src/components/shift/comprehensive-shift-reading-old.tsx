   ...
   const [dispensers, setDispensers] = useState<DispenserReading[]>(() => [
      {
         ...
         ms_pump: createEmptyPumpReading("MS-An1", "MS", fuelPrices.MS),
         hsd_pump: createEmptyPumpReading("HSD-An1", "HSD", fuelPrices.HSD),
      },
      {
         dispenser_name: "DSM-Bn1",
         ms_pump: createEmptyPumpReading("MS-Bn1", "MS", fuelPrices.MS),
         hsd_pump: createEmptyPumpReading("HSD-Bn1", "HSD", fuelPrices.HSD),
      },
      {
         dispenser_name: "DSM-An2",
         ms_pump: createEmptyPumpReading("MS-An2", "MS", fuelPrices.MS),
         hsd_pump: createEmptyPumpReading("HSD-An2", "HSD", fuelPrices.HSD),
      },
      {
         dispenser_name: "DSM-Bn2",
         ms_pump: createEmptyPumpReading("MS-Bn2", "MS", fuelPrices.MS),
         hsd_pump: createEmptyPumpReading("HSD-Bn2", "HSD", fuelPrices.HSD),
      },
   ]);
         ...
         <CardContent className='space-y-6'>
            ...
            <div className='flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800'>
               <div>
                  ...
                  <p className='text-sm text-blue-600 dark:text-blue-300'>
                     Paste pump reading data from spreadsheet to auto-fill the form
                  </p>
               </div>
               <Button
                  variant='outline'
            ...
            <div className='overflow-x-auto'>
               <table className='w-full border border-border rounded-lg'>
                  <thead className='bg-muted'>
                     <tr>
                        <th className='text-left p-3 border-b'>Dispenser</th>
            ...
            <div className='flex justify-between items-center'>
               <div className='text-sm text-muted-foreground'>
                  * Pump Test is only applicable for Shift I
               </div>
